...
try:
    ...
    import platform.linux_distribution as distro
...
class OpenShotApp(QApplication):
    ...
    def __init__(self, *args, mode=None):
        ...
        try:
            ...
            from openshot_qt.classes import (
        ...
        try:
            log.info("------------------------------------------------")
            log.info(("OpenShot (version %s)" % openshot_qt.__version__).center(48))
            log.info("------------------------------------------------")
            log.info("package: %s", __package__)
